...
const SPECIMENS: Specimen[] = [
  ...
  {num:'06',code:'APD-006',category:'Fermentare Proprie',nameRo:'Miso de Fasole Românească',latin:'Phaseolus vulgaris + koji',nameLarge:'Miso',badge:'Produs intern',badgeCls:'fermentat',meta:[{k:'Producție',ro:'Bucătăria Atelierului',en:'Atelier kitchen'},{k:'Maturare',ro:'90–180 zile',en:'90–180 days'},{k:'Lot curent',ro:'Lot #3',en:'Batch #3'}],spectrum:['rgba(160,120,80,.6)','rgba(180,140,80,.5)','rgba(140,100,60,.5)','rgba(100,80,60,.4)','rgba(80,60,40,.3)'],pills:['Umami','Sărat','Fermentat'],descRo:'Tehnica e universală. Fasolea e din Ardeal. Fermentarea e în borcane numerotate.',descEn:'The technique is universal. The bean is Transylvanian. The fermentation is ours.',noteRo:'Tehnica este universală. Ingredientul este al meu.',noteEn:'The technique is universal. The ingredient is mine.',usage:['Somon','Glazură vițel','Baze de sos','Unt de miso']},
        ...
        <div className="section" style={{padding:'0 48px'}}>
          ...
          <div className="services-grid">
            <div className="svc reveal d1">
              ...
              <a href="/oglinda.html" className="svc-product-badge svc-product-badge--link">Oglinda →</a>
            </div>
            <div className="svc reveal d2">
              ...
              <a href="/tesatura" className="svc-product-badge svc-product-badge--link">Țesătura →</a>
            </div>
            <div className="svc reveal d3">
              ...
              <a href="/temelia" className="svc-product-badge svc-product-badge--link">Temelia →</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="menu-prev-wrap reveal">
            ...
            <div className="menu-courses">
              {[
                ...
                {n:'IV', label:'Pește · Starter', name:'Somon și avocado', desc:'Somon norvegian curat la 52°C · avocado · icre de somon roz · vinegretă de citrice și mărar · crocant de capere'},
                ...
                {n:'VII', label:'Pește', name:'Calcan de Marea Neagră și unt brun', desc:'Calcan sălbatic de Marea Neagră · glazură de unt brun-noisette · hribi sotați · lămâie murată · piure de țelină'},
      ...
      <div id="gelato" className="gelato-section-wrap">
        <div className="gelato-inner">
          ...
          <div className="gelato-grid reveal">
            {[
              {e:'🖤',n:'Susan Negru',en:'Black Sesame · Ancient Paste · Buffalo Milk',d:'Pasta de susan negru prăjit — cea mai profundă culoare naturală pe care o poți pune pe linguriță — în lapte de bivoliță. Umami discret, nucă adâncă, antracit absolut. Nicio colorare artificială.',notes:['Nucă adâncă','Umami fin','Negru-antracit'],season:'Tot anul',rare:false},
              ...
              {e:'🍋',n:'Lămâie Confiată',en:'Slow-Cooked Lemon · Cardamom · Condensed Buffalo Milk',d:'O tehnică veche de lapte redus lent, fiert, nu turnat direct la congelator. Lămâie confiată, cardamom verde, lapte de bivoliță redus. O textură pe care alte gelato-uri nu o au.',notes:['Citric intens','Cardamom','Dens'],season:'Tot anul',rare:false},
              {e:'🌶️',n:'Ardei Afumat & Ciocolată',en:'Smoked Chili · Dark Chocolate 72% · Buffalo Milk',d:'Căldura fumată a ardeiului iute românesc întâlnește ciocolata amară la 72%. O căldură lentă care rămâne după ultima linguriță.',notes:['Ciocolată amară','Fum dulce','Căldură'],season:'Tot anul',rare:false},
            ...
            if (hasPrivate && !hasCorporate) {
              return (
                <div style={{alignSelf:'flex-start',marginTop:'4px'}}>
                  <a href="/oglinda.html" target="_blank" rel="noopener noreferrer" style={{
