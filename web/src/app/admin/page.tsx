    ...
    <div style={S.page}>
      ...
      <main style={{maxWidth:'1400px',margin:'0 auto',padding:'40px 32px'}}>
        ...
        <div style={{marginTop:'80px',paddingTop:'48px',borderTop:'1px solid #1a1a1a'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr',maxWidth:'400px',marginBottom:'24px'}}>
            {/* Răzvan */}
          ...
          <button
            ...
            onClick={() => {
              const G='#c9a96e';
              const s=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 525 600"><defs><linearGradient id="lb" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#060606"/><stop offset="100%" stop-color="#141414"/></linearGradient><linearGradient id="lf" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="${G}" stop-opacity="0"/><stop offset="50%" stop-color="${G}" stop-opacity="1"/><stop offset="100%" stop-color="${G}" stop-opacity="0"/></linearGradient></defs><rect x="0" y="0" width="525" height="600" fill="url(#lb)"/><text x="263" y="258" text-anchor="middle" font-family="Georgia,serif" font-size="10" letter-spacing="6" fill="${G}">ATELIER</text><text x="263" y="334" text-anchor="middle" font-family="Georgia,serif" font-size="38" font-weight="bold" fill="#ffffff">Răzvan</text><text x="263" y="364" text-anchor="middle" font-family="Georgia,serif" font-size="9" letter-spacing="5" fill="${G}">CHEF / FONDATOR</text><rect x="163" y="382" width="200" height="0.8" fill="url(#lf)"/><text x="263" y="422" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#666">exquisitefoodtravel@yahoo.com</text></svg>`;
